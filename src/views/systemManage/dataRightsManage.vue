<template>
  <div class="p-t-20">
    ...
    <div class="search-bg">
        <!-- 所属机构 -->
        <YcSearchInput v-model="search.condition.userType" title="状态" />
    ...
    <div class="table-bg">
      <div class="table-option">
        <div class="left"></div>
        <div class="right">
            <el-button type="primary" @click="$router.push('/systemManage/addEditPermission')">新建数据权限</el-button>
        </div>
      </div>
      <el-table :data="tableData">
        <el-table-column prop="updatedTime" label="ID" min-width="120" />
        <el-table-column prop="updatedTime" label="数据权限岗名称" min-width="100" />
        <el-table-column prop="updatedTime" label="数据范围" min-width="120" />
        <el-table-column prop="updatedTime" label="创建时间" min-width="100" />
        <el-table-column prop="updatedTime" label="最后一次更新时间" min-width="180" />
        <el-table-column prop="updatedTime" label="状态" min-width="100">
        ...
        <el-table-column prop="name" label="操作" min-width="100" fixed="right">
          <template slot-scope="scope">
            <el-button type="text" @click="$router.push('/systemManage/addEditPermission?id=1')">编辑</el-button>
